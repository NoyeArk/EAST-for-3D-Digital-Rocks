...
parser.add_argument(
    "--n_threads", type=int, default=8, help="number of threads for data loading"
)
...
_default_dir_data = os.path.join(
...
parser.add_argument(
    "--dir_data", type=str, default=_default_dir_data, help="dataset directory"
)
parser.add_argument(
    "--dir_demo",
    type=str,
...
parser.add_argument(
    "--data_train", type=str, default="DRSRD", help="train dataset name"
)
...
parser.add_argument(
    "--n_colors", type=int, default=1, help="number of color channels to use"
)
parser.add_argument(
...
parser.add_argument(
    "--noise", action="store_true", help="add noise and blur to low resolution images"
)
...
parser.add_argument("--window_sizes", type=str, default="4-8-8", help="window sizes")
...
parser.add_argument(
    "--test_every", type=int, default=1, help="do test per every N epochs"
)
...
parser.add_argument(
    "--warm_up", type=int, default=0, help="warm up step, if 0 no warm up"
)
...
parser.add_argument(
    "--optimizer",
    default="ADAM",
    choices=("SGD", "ADAM", "RMSprop", "AdamW", "Sophia"),
    help="optimizer to use (SGD | ADAM | RMSprop | AdamW | Sophia)",
)
...
parser.add_argument(
    "--weight_decay", type=float, default=1e-3, help="weight decay"  # 0.01
)
parser.add_argument(
    "--gclip",
    type=float,
