...
class Trainer:
    def __init__(self, args, loader, my_model, my_loss, ckp):
        ...
        self.ckp.write_log("Parameters: %d" % (calculate_parameters(self.model)))
        ...
        for batch, (
            ...
            if self.args.gclip > 0:
                ...
                utils.clip_grad_norm_(
                    self.model.parameters(), max_norm=self.args.gclip, norm_type=2
                )
    ...
    def test(self):
            ...
            for idx_scale, scale in enumerate(self.scale):
                ...
                self.ckp.write_log(
                    "[{} x{}]\tPSNR: {:.3f} (Best: {:.3f} @epoch {})".format(
                        ...
                        (best[1][idx_data, idx_scale] + 1) * self.args.test_every,
        ...
        if not self.args.test_only:
            ...
            self.ckp.save(
                self,
                epoch,
                is_best=((best[1][0, 0] + 1) * self.args.test_every == epoch),
            )
